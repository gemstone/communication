...
//       Fixed an issue in AddHeader() that was putting the length of the provided buffer in the header 
//       instead of the length specified in the method parameter.
//  01/30/2011 - Pinal C. Patel
//       Fixed an issue in AddHeader() that created an insufficient return buffer when the specified
