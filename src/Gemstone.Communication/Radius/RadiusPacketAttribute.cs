...
namespace Gemstone.Communication.Radius
{
    ...
    public enum AttributeType
    {
        ...
        /// <summary>
        /// Attribute indicates the system with which to connect the user when <see cref="LoginService"/> attribute is included.
        /// </summary>
        LoginIpHost = 14,
        /// <summary>
        ...
        LoginService = 15,
        /// <summary>
        /// Attribute indicates the TCP port with which the user is to be connected when <see cref="LoginService"/> attribute is included.
        /// </summary>
        LoginTcpPort = 16,
        /// <summary>
    ...
    public class RadiusPacketAttribute : ISupportBinaryImage
    {
        ...
        public int BinaryLength => 2 + m_value.Length;
