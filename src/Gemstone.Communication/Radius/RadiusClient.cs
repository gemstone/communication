...
namespace Gemstone.Communication.Radius
{
    ...
    public class RadiusClient : IDisposable
    {
        ...
        public RadiusClient(string serverName, int serverPort, string sharedSecret)
        {
            ...
            m_requestAttempts = 1;
            m_reponseTimeout = 15000;
            
            m_sharedSecret = sharedSecret;
            m_newPinModeMessage1 = DefaultNewPinModeMessage1;
            m_newPinModeMessage2 = DefaultNewPinModeMessage2;
            m_newPinModeMessage3 = DefaultNewPinModeMessage3;
            m_nextTokenModeMessage = DefaultNextTokenModeMessage;
