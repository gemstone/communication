...
namespace Gemstone.Communication
{
    ...
    public class UdpClient : ClientBase
    {
        ...
        {
            ReceiveDataFrom?.SafeInvoke(this, new EventArgs<EndPoint, IPPacketInformation, int>(remoteEndPoint, packetInformation, size));
        }
        ...
        {
            ReceiveDataFromComplete?.SafeInvoke(this, new EventArgs<EndPoint, IPPacketInformation, byte[], int>(remoteEndPoint, packetInformation, data, size));
        }
