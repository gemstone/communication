...
namespace Gemstone.Communication
{
    ...
    public class SerialClient : ClientBase
    {
        ...
        /// Initializes a new instance of the <see cref="SerialClient"/> class.
        /// </summary>
        /// <param name="connectionString">Connect string of the <see cref="SerialClient"/>. See <see cref="DefaultConnectionString"/> for format.</param>
        public SerialClient(string connectionString) : base(TransportProtocol.Serial, connectionString) =>
