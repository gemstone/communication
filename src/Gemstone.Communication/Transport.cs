...
//       Multiple additions and updates to accommodate easier IPv6 or IPv4 selection as well as
...
namespace Gemstone.Communication
{
    ...
    public static class Transport
    {
        ...
        public static IPEndPoint CreateEndPoint(string hostNameOrAddress, int port, IPStack stack)
        {
            ...
            try
            {
                // Handle "localhost" as a special case, returning proper loop-back address for the desired IP stack
